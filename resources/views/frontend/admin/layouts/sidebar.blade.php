<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="{{route('admindashboard')}}">
       <img src="{{ asset('assets/images/login-img.jpeg') }}" alt="">
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="{{ route('ViewCalander') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="" background-color: #34ebc0; !important">
              <title>shop </title>
          ...
          <span class="nav-link-text ms-1" style="Font-size: larger;">Dashboard</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link  " href="{{ route('allcustomer')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#pagesExamples5" class="nav-link collapsed" aria-controls="pagesExamples4" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="collapse" id="pagesExamples5" style="">
          <ul class="nav ms-4 ps-3">
            ...
            <li class="nav-item ">
              <a class="nav-link " href="{{route('allproductcategory')}}">
                <span class="sidenav-mini-icon"> </span>
                <span class="sidenav-normal"> Product's Categories </span>
              </a>
            </li>
            <li class="nav-item ">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="{{route('wareHouses')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="{{route('allExpenses')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Expenses Management</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#pagesExamples20" class="nav-link collapsed" aria-controls="pagesExamples4" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="collapse" id="pagesExamples20" style="">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('allExpensesReports') }}">
                <span class="sidenav-mini-icon"> </span>
                <span class="sidenav-normal">Expense Reports </span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link" href="{{ route('allSalesReports') }}">
                <span class="sidenav-mini-icon"> </span>
      ...
      <li class="nav-item">
        <a class="nav-link  " href="{{route('allPurchase')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Purchase Expense Management</span>
        </a>
      </li>
      
       <li class="nav-item">
        <a class="nav-link  " href="{{route('adminquotation')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <span class="nav-link-text ms-1">Quotation Management</span>
        </a>
      </li>
     
      <!-- <li class="nav-item">
        <a class="nav-link  " href="{{route('leadsManagement')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Manage Client Profile</span>
        </a>
      </li> -->
      ...
      <!-- <li class="nav-item">
        <a data-bs-toggle="collapse" href="#pagesExamples4" class="nav-link collapsed" aria-controls="pagesExamples4" role="button" aria-expanded="false">
          ...
          <span class="nav-link-text ms-1">Driver Management</span>
        </a>
          ...
          <ul class="nav ms-4 ps-3">
            <li class="nav-item ">
              <a class="nav-link " href="#">
                ...
                <span class="sidenav-normal"> Driver Profile </span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link " href="#">
                <span class="sidenav-mini-icon"> D </span>
                <span class="sidenav-normal"> Driver Job History </span>
              </a>
            </li>
          ...
          <ul class="nav ms-4 ps-3">
            <li class="nav-item ">
              <a class="nav-link " href="{{ route('salaryEmployee') }}">
                <span class="sidenav-mini-icon"> </span>
                <span class="sidenav-normal">Employees Salary</span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link " href="{{ route('payStructure') }}">
                <span class="sidenav-mini-icon"> </span>
                <span class="sidenav-normal"> Pay Structure </span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="{{ route('tripDetails') }}">
                <span class="sidenav-mini-icon"> </span>
                <span class="sidenav-normal">Driver's Trip Details </span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#pagesExamples11" class="nav-link collapsed" aria-controls="pagesExamples4" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#pagesExamples12" class="nav-link collapsed" aria-controls="pagesExamples4" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="collapse" id="pagesExamples12" style="">
          <ul class="nav ms-4 ps-3">
            <li class="nav-item ">
              <a class="nav-link " href="{{ route('attendanceDetails') }}">
                <span class="sidenav-mini-icon"> </span>
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#pagesExamples13" class="nav-link collapsed" aria-controls="pagesExamples4" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item mt-3">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">SMRP-Logistic Management </h6>
      </li>
      <li class="nav-item">
        <a class="nav-link  " href="{{ route('viewOrders') }}">
          ...
          <span class="nav-link-text ms-1">Logistic-CRM</span>
        </a>
      </li>
      <li class="nav-item">
          ...
          <ul class="nav ms-4 ps-3">
            ...
            <li class="nav-item ">
              <a class="nav-link " href="{{ route('orderStatus')}}">
                <span class="sidenav-mini-icon"> C </span>
                <span class="sidenav-normal"> Orders Status </span>
              </a>
            </li>
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#pagesExamples6" class="nav-link collapsed" aria-controls="pagesExamples4" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <ul class="nav ms-4 ps-3">
            <li class="nav-item ">
              <a class="nav-link " href="{{ route('drivers') }}">
                <span class="sidenav-mini-icon"> S </span>
                <span class="sidenav-normal"> Drivers Profile</span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link " href="{{ route('ViewCalander') }}">
                <span class="sidenav-mini-icon"> S </span>
                <span class="sidenav-normal"> Assign Drivers </span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link " href="{{ route('deliveries') }}">
                <span class="sidenav-mini-icon"> C </span>
                <span class="sidenav-normal"> Delivery Status</span>
              </a>
            </li>
       ...
       <li class="nav-item">
          <a class="nav-link" href="{{ route('driverOverview') }}">
            ...
            <span class="nav-link-text ms-1">Driver Schedule History</span>
          </a>
        </li> 
      @endif
      @if(role_test()==4)
      ...
      <li class="nav-item">
        <a class="nav-link  " href="{{route('otherWareHouse')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>settings</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ route('collection_form')}}">
          ...
          <span class="nav-link-text ms-1">Collection Form</span>
        </a>
      </li>
      ...
      @if(role_test()==3)
      <li class="nav-item">
        <a class="nav-link" href="{{route('giveAttendance')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>settings</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ route('employeeLeave')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>settings</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Employee Leave</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ route('employeeClaims')}}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>settings</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Employee Claims</span>
        </a>
      </li>
      @endif
      <li class="nav-item mt-3">
