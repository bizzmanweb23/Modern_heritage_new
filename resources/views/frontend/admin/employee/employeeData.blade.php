                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <span class="view_span">{{ $employee->emp_name }}</span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <span class="view_span">{{ $employee->work_mobile }}</span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <span class="view_span">{{ $employee->department_name }}</span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <span class="view_span">{{ $employee->work_phone }}</span>
                            <div class="row edit_input">
                                <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <span class="view_span">{{ $employee->manager_name }}</span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <span class="view_span">{{ $employee->work_email }}</span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <span class="view_span">
                                @foreach ($selected_customers_name as $item)
                                    <div class="card" style="background-color: steelblue; border-radius: 10px; display:inline; color: white; margin-right: 10px; padding-right: 10px; padding-left: 10px"">
                                        {{ $item }}
                                    </div>    
                                @endforeach    
                            </span>
                            <select multiple="multiple" name="default_customer[]" id="default_customer" class="form-control edit_input">
                                @foreach($customer as $c)
                                    <option value="{{ $c->id }}" {{ isset($selected_customers) && in_array($c->id,$selected_customers) ? 'selected' : '' }}>
                                        {{ $c->customer_name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->contact_address }}</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->country }}</span>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->contact_email }}</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->identification_no }}</span>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->contact_phone }}</span>
                                <div class="row edit_input">
                                    <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->passport_no }}</span>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->bank_accnt_no }}</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->gender }}</span>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        @if (isset($employee->home_work_distance))
                                            <span class="view_span">{{ $employee->home_work_distance }} KM</span>
                                        @endif
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="dob">Date of Birth:</label>
                                        <span class="view_span">{{ $employee->dob }}</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="place_of_birth">Place of Birth:</label>
                                        <span class="view_span">{{ $employee->place_of_birth }}</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="country_of_birth">Country of Birth:</label>
                                        <span class="view_span">{{ $employee->country_of_birth }}</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->other_id_name }}</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->other_id_no }}</span>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->edu_certificate_level }}</span>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->field_of_study }}</span>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="view_span">{{ $employee->school }}</span>
