            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="emp_id" id="emp_id" class="form-control" required>
                        ...
                        <option value="{{$emp->id}}" @if($emp->id == $emp_salary->emp_id) selected @endif>{{$emp->emp_name}} </option>
                        @endforeach
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="designation" id="designation" class="form-control" onChange="chk_fields(this.value)" required>
                        ...
                        <option value="{{$j_pos->id}}"  @if($j_pos->id == $emp_salary->designation) selected @endif>{{$j_pos->position_name}} </option>
                        @endforeach
                ...
                <div class="row" id="normal_employee">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="basic_pay" name="basic_pay" value="{{$emp_salary->basic_pay}}" onkeyup="calcSalary()" >
                    </div>
                    <div class="form-group col-md-6">
                        <label>Commission</label>
                        <input type="hidden" name="da" value="{{$pay_structures->commission}}" id="da">
                        <input type="text" class="form-control" id="commission" name="commission" value="{{$emp_salary->commission}}">
                    </div>
                    <div class="form-group col-md-6">
                        <label>CPF</label>
                        <input type="hidden" name="pf" value="{{$pay_structures->cpf}}" id="pf">
                        <input type="text" class="form-control" id="cpf" name="cpf" value="{{$emp_salary->cpf}}" >
                    </div>
                    <div class="form-group col-md-6">
                        <label>Insurance</label>
                        <input type="hidden" name="esi" value="{{$pay_structures->insurance}}" id="esi">
                        <input type="text" class="form-control" id="insurance" name="insurance" value="{{$emp_salary->insurance}}">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Medical Leave Entitlement </label>
                        <input type="hidden" name="ma" value="{{$pay_structures->medical_leave}}" id="ma">
                        <input type="text" class="form-control" id="medical_leave_entitlement" name="medical_leave_entitlement" value="{{$emp_salary->medical_leave}}">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Medical Allowance</label>
                        <input type="hidden" name="mle" value="{{$pay_structures->medical_allowance}}" id="mle">
                        <input type="text" class="form-control" id="medical_allowance" name="medical_allowance" value="{{$emp_salary->medical_allowance}}" >
                    </div>
                    <div class="form-group col-md-6">
                        <label>Total Earning</label>
                        <input type="text" class="form-control" id="earning_a" name="earning_a" value="{{$emp_salary->earning}}">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Total Deduction</label>
                        <input type="text" class="form-control" id="deduction" name="deduction" value="{{$emp_salary->deduction}}">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Net Pay</label>
                        <input type="text" class="form-control" id="net_pay" name="net_pay" value="{{$emp_salary->net_pay}}">
                    </div>
                </div>
                <div class="row" id="driver">
                    <div class="form-group col-md-6">
                        <label>Per Trip Charge</label>
                        <input type="text" class="form-control" id="per_trip_charge" name="per_trip_charge" value="{{$emp_salary->per_trip_charge}}" >
                    </div>
                    <div class="form-group col-md-6">
