...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <div class="container py-4">
            <div class="row">
                <div class="col-6 ">
                    <a class="btn bg-gradient-dark mb-0" href="#" data-bs-toggle="modal"
                        data-bs-target="#myModal"><i class="fas fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;View</a>
                </div>
                <div class="col-6 ">
                    <a class="btn bg-gradient-dark mb-0" href="#"><i class="fas fa-plus"
                            aria-hidden="true"></i>&nbsp;&nbsp;Download</a>
                </div>
            </div>

            <!-- this is modal for bill download-->
            <!-- The Modal -->
                    ...
                    <div class="modal-content" style="width: 800px;">
                        ...
                        <div class="modal-body">
                            <div class="bill-logo text-center">
                                <img src="{{asset('assets/img/logobill.jpg')}}" alt="" class="img-fluid mb-2"
                                    style="width: 300px;">
                                <p class="text-center my-0">
                                    Blk 2029 BUKIT STREET 23, #01-290, SINGAPORE 659534
                                </p>
                            ...
                            <div class="modern-lorry-text">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><strong>Kind Attn: Valued Customers</strong></p>
                                    </div>
                                ...
                                <div class="container">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>10Ft Lorry with tallygate</td>
                                                    <td>$60.00/ Trip</td>
                                                    <td>$30.00 / hr</td>
                                                    <td>$30.00 /locn</td>
                                                    <td>$45.00 / hr</td>
